export const en = {
  ...
  hero: {
    ...
    title: "The operating system for kitchens, rooms, and the cash between them.",
    body: "Four engineered modules for modern hospitality. Run them standalone — or fuse Costora, Menura, EasyRoom, and Ledger into a single operating fabric.",
  ...
  synergy: {
    ...
    title: "Standalone they work. Synced they compound.",
  ...
  suite: {
    kicker: "The suite",
    title: "Engineered from real operations.",
    body: "These are not pitch decks. Costora, Menura, and EasyRoom are running systems — read from the product repos, not from a brochure. Ledger is the accounting layer that closes the loop.",
    talk: "Talk to us",
    explore: "Explore",
  ...
  bespoke: {
    ...
    title: "When the suite is not the whole answer, we still build the system.",
  ...
  footer: {
    blurb: "The intelligent operating system for modern hospitality and enterprise.",
    suite: "Suite",
    studio: "Studio",
    contact: "Contact",
